...
public class CNSTN {
    ...
    public static final String AFKey = "WnhYUGY5Y3NWdHFnSzJKVm5Md0FWaA==";
    public static final String OneSignalId = "YzBkZjMzZTItMTQ1Ni00ZTA0LWI4MGUtZjFlNTdhOGExMDhm";
